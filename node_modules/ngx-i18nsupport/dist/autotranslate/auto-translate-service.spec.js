...
describe('Autotranslate tests', function () {
    ...
    it('should translate simple words from en to de', function (done) {
        if (!service) {
            done();
            return;
        }
    ...
    it('should translate empty string from en to de', function (done) {
        if (!service) {
            done();
            return;
        }
        service.translateMultipleStrings(['', 'world'], 'en', 'de').subscribe(function (translations) {
            expect(translations).toBeTruthy();
            expect(translations.length).toBe(2);
    ...
    it('should accept empty array of translations', function (done) {
        if (!service) {
            done();
            return;
        }
        service.translateMultipleStrings([], 'en', 'de').subscribe(function (translations) {
            expect(translations).toBeTruthy();
    ...
    it('should translate to french apostrophes (#94)', function (done) {
        if (!service) {
            done();
            return;
        }
        service.translateMultipleStrings(['Operator Logs'], 'en', 'fr').subscribe(function (translations) {
            expect(translations).toBeTruthy();
    ...
    it('should translate to german umlaut (#94)', function (done) {
        if (!service) {
            done();
            return;
        }
        service.translateMultipleStrings(['green doors'], 'en', 'de').subscribe(function (translations) {
            expect(translations).toBeTruthy();
            expect(translations.length).toBe(1);
