 ...
 */
describe('XliffMerge XMB format tests', function () {
    /**
     * Workdir, not in git.
    ...
    describe('Merge process checks for format xmb', function () {
        ...
        it('should generate translated file for default language de from xmb master', function (done) {
            ...
            var langFile = readXtbWithMaster(xliffMergeCmd.generatedI18nFile('de'), MASTER);
        ...
        it('should not remove trailing line break when merging', function (done) {
            file_util_1.FileUtil.copy(MASTER1SRC, MASTER);
            var masterContent = file_util_1.FileUtil.read(MASTER, xml_reader_1.XmlReader.DEFAULT_ENCODING);
            ...
            xliffMergeCmd.run();
            expect(ws.writtenData()).not.toContain('ERROR');
            var newContent = file_util_1.FileUtil.read(xliffMergeCmd.generatedI18nFile('de'), xml_reader_1.XmlReader.DEFAULT_ENCODING);
        ...
        it('should return status new for all trans units using format xmb with master file', function (done) {
            file_util_1.FileUtil.copy(MASTER1SRC, MASTER);
            var ws = new writer_to_string_1.WriterToString();
            var commandOut = new command_output_1.CommandOutput(ws);
            var profileContent = {
        ...
        it('should return status final for a translated trans unit using format xmb with master file', function (done) {
            file_util_1.FileUtil.copy(MASTER1SRC, MASTER);
            var ws = new writer_to_string_1.WriterToString();
            var commandOut = new command_output_1.CommandOutput(ws);
            var profileContent = {
    ...
    describe('ngx-translate processing for format xmb', function () {
        ...
        var MASTER1SRC = SRCDIR + MASTER1FILE;
        var MASTER_WITHOUT_NGX_TRANSLATE_STUFF = SRCDIR + 'ngExtractedMaster1.xmb';
        var MASTERFILE = 'messages.xmb';
        var MASTER = WORKDIR + MASTERFILE;
        ...
        it('should not export @@ids to translation json file, when this is supressed in pattern (issue #62)', function (done) {
            file_util_1.FileUtil.copy(MASTER1SRC, MASTER);
            var ws = new writer_to_string_1.WriterToString();
            var commandOut = new command_output_1.CommandOutput(ws);
            var profileContent = {
        ...
        it('should export other then ngx-translate description marked entries to translation json file, when this is specified in pattern (issue #62)', function (done) {
            file_util_1.FileUtil.copy(MASTER1SRC, MASTER);
            var ws = new writer_to_string_1.WriterToString();
            var commandOut = new command_output_1.CommandOutput(ws);
            var profileContent = {
...
//# sourceMappingURL=S:/experimente/ngx-i18nsupport/xliffmerge/xmb-merge.spec.js.map