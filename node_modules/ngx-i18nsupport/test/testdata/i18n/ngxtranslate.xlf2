...
<xliff version="2.0" xmlns="urn:oasis:names:tc:xliff:document:2.0" srcLang="de" trgLang="en">
  ...
  enthält einen Zeilenumbruch.</source>
    ...
    <unit id="6830980354990918031">
      <notes>
        <note category="description">alt-ngx-translate</note>
        <note category="meaning">alt-ngx-translate.example1</note>
      </notes>
      <segment state="final">
        <source>Alternate description for ngx-translate export</source>
        <target>Alternate description for ngx-translate export</target>
      </segment>
    </unit>
  </file>
</xliff>
