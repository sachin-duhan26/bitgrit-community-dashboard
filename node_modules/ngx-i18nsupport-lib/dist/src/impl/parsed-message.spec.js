 ...
 */
describe('normalized message test spec', function () {
    /**
    ...
    function parsedMessageFor(normalizedString, sourceMessage) {
        var parser = new xliff2_message_parser_1.Xliff2MessageParser(); // parser does not matter here, every format should be the same.
    ...
    describe('validation test cases ', function () {
        it('should find nothing wrong with simple text message', function () {
            var translation = 'a text without anything special';
            var parsedMessage = parsedMessageFor(translation);
            expect(parsedMessage.validate()).toBeFalsy();
            expect(parsedMessage.validateWarnings()).toBeFalsy();
        });
        it('should find nothing wrong with simple text as translation of simple text', function () {
            var original = 'any text';
            var translation = 'a text without anything special';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
            expect(translatedMessage.validateWarnings()).toBeFalsy();
        });
        it('should warn if you remove a placeholder in the translation', function () {
            var original = 'a text with placeholder: {{0}}';
            var translation = 'a text without anything special';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
        ...
        it('should warn if you remove 2 placeholders in the translation', function () {
            var original = 'a text with placeholders: {{0}} and {{1}}';
            var translation = 'a text without anything special';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
        ...
        it('should report an error if you add a new placeholder in the translation', function () {
            var original = 'a text with placeholder: {{0}}';
            var translation = 'a text with 2 placeholders: {{0}} and {{1}}';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validateWarnings()).toBeFalsy();
        ...
        it('should report an error if you add 2 new placeholders in the translation', function () {
            var original = 'a text with placeholder: {{0}}';
            var translation = 'a text with 3 placeholders: {{0}} and {{1}} and {{2}}';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validateWarnings()).toBeFalsy();
            var errors = translatedMessage.validate();
        ...
        it('should not report an error if you duplicate a placeholder in the translation', function () {
            var original = 'a text with placeholder: {{0}}';
            var translation = 'a text with a duplicated placeholders: {{0}} and {{0}}';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
            expect(translatedMessage.validateWarnings()).toBeFalsy();
        });
        it('should warn if you remove a tag in the translation', function () {
            var original = 'a <b>bold</b> text';
            var translation = 'a non bold text';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
            var warnings = translatedMessage.validateWarnings();
        ...
        it('should warn if you add a tag in the translation', function () {
            var original = 'a normal text';
            var translation = 'a <strange>text</strange>';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
            var warnings = translatedMessage.validateWarnings();
        ...
        it('should warn if you remove an empty tag in the translation', function () {
            var original = 'a text with <br>line break and <img>';
            var translation = 'a text';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
            var warnings = translatedMessage.validateWarnings();
        ...
        it('should warn if you add an empty tag in the translation', function () {
            var original = 'a normal text';
            var translation = 'a normal text with <br> line break';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
            var warnings = translatedMessage.validateWarnings();
        ...
        it('should warn if you add 2 empty tags in the translation', function () {
            var original = 'a normal text';
            var translation = 'a normal text with <br> line break and <img>';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validate()).toBeFalsy();
            var warnings = translatedMessage.validateWarnings();
        ...
        it('should find nothing wrong with text containing line breaks', function () {
            var original = 'a text without\na line break';
            var translation = 'a text without\na line break';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
        ...
        it('should find nothing wrong in complex nested tags', function () {
            var original = '<span>a <b>bold</b> text</span> and <span>a <b>bold</b> text</span>';
            var translation = '<span>a <b>bold</b> text</span> and <span>a <b>bold</b> text</span>';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.asDisplayString()).toBe(translation);
            expect(translatedMessage.validate()).toBeFalsy();
        ...
        it('should report an error if you remove an ICU ref in the translation', function () {
            var original = 'a text with <ICU-Message-Ref_0/>';
            var translation = 'a text without icu-ref';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validateWarnings()).toBeFalsy();
            var errors = translatedMessage.validate();
        ...
        it('should report an error if you remove 2 ICU refs in the translation', function () {
            var original = 'a text with <ICU-Message-Ref_0/> and <ICU-Message-Ref_1/>';
            var translation = 'a text without icu-ref';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validateWarnings()).toBeFalsy();
        ...
        it('should report an error if you add an ICU ref in the translation', function () {
            var original = 'a text with <ICU-Message-Ref_0/>';
            var translation = 'a text with <ICU-Message-Ref_0/> and  <ICU-Message-Ref_1/>';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validateWarnings()).toBeFalsy();
            var errors = translatedMessage.validate();
        ...
        it('should report an error if you add 2 ICU refs in the translation', function () {
            var original = 'a text with <ICU-Message-Ref_0/>';
            var translation = 'a text with <ICU-Message-Ref_0/> and  <ICU-Message-Ref_1/> and  <ICU-Message-Ref_2/>';
            var sourceMessage = parsedMessageFor(original);
            var translatedMessage = sourceMessage.translate(translation);
            expect(translatedMessage.validateWarnings()).toBeFalsy();
            var errors = translatedMessage.validate();
        ...
        it('should parse tags with - and [0-9]', function () {
            var original = '<h1><md-icon>info</md-icon></h1>';
            var sourceMessage = parsedMessageFor(original);
            expect(sourceMessage.parts().length).toBe(5);
        });
    });
    describe('ICU test cases', function () {
        it('should parse ICU plural message', function () {
            var original = '{n, plural, =0 {kein Schaf} =1 {ein Schaf} other {Schafe}}';
            var sourceICUMessage = parsedICUMessage(original);
        ...
        it('should parse ICU select message', function () {
            var original = '{gender, select, m {männlich} f {weiblich}}';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
            expect(sourceICUMessage.getICUMessage()).toBeTruthy();
        ...
        it('should parse ICU select message with select or plural in message text', function () {
            var original = '{VAR_SELECT, select, wert0 {value0 selected} wert1 {plural selected} wert2 {anything else selected} }';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
            expect(sourceICUMessage.getICUMessage()).toBeTruthy();
            expect(sourceICUMessage.getICUMessage().isPluralMessage()).toBeFalsy();
        ...
        it('should parse ICU select message with masked } {', function () {
            var original = '{VAR_SELECT, select, wert0 {value0 \'}\'\'\'\'{\'}}';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
            expect(sourceICUMessage.getICUMessage()).toBeTruthy();
            expect(sourceICUMessage.getICUMessage().isPluralMessage()).toBeFalsy();
        ...
        it('should translate ICU plural message', function () {
            var original = '{n, plural, =0 {kein Schaf} =1 {ein Schaf} other {Schafe}}';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
            var translatedICUMessage = sourceICUMessage.translateICUMessage({
                '=0': 'no sheep',
                '=1': 'one sheep',
                'other': 'sheep'
            });
        ...
        it('should translate ICU plural message with new categories', function () {
            var original = '{n, plural, =0 {kein Schaf} =1 {ein Schaf} other {Schafe}}';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
            var translatedICUMessage = sourceICUMessage.translateICUMessage({
        ...
        it('should throw an error when translation of ICU plural message adds invalid category', function () {
            var original = '{n, plural, =0 {kein Schaf} =1 {ein Schaf} other {Schafe}}';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
            try {
        ...
        it('should translate ICU select message', function () {
            var original = '{gender, select, m {männlich} f {weiblich}}';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
            var translatedICUMessage = sourceICUMessage.translateICUMessage({
        ...
        it('should partially translate ICU select message', function () {
            var original = '{gender, select, m {männlich} f {weiblich}}';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
        ...
        it('should throw an error if translation of ICU select message contains additional categories', function () {
            var original = '{gender, select, m {männlich} f {weiblich}}';
            var sourceICUMessage = parsedICUMessage(original);
            expect(sourceICUMessage).toBeTruthy();
            try {
        ...
        it('should parse plural ICU message with placeholder in xlf format', function () {
            var original = '{minutes, plural, =0 {just now} =1 {one minute ago} other {<x id="INTERPOLATION" equiv-text="{{minutes}}"/> minutes ago} }';
            var parsedMessage = parsedICUMessage(original, null, 'xlf');
        ...
        it('should parse plural ICU message with placeholder in xlf2 format', function () {
            var original = '{minutes, plural, =0 {just now} =1 {one minute ago} other {<ph id="3" equiv="INTERPOLATION" disp="{{minutes}}"/> minutes ago} }';
            var parsedMessage = parsedICUMessage(original);
            expect(parsedMessage.asDisplayString()).toBe('<ICU-Message/>');
            expect(parsedMessage.getICUMessage()).toBeTruthy();
            var icuMessage = parsedMessage.getICUMessage();
            expect(icuMessage.getCategories().length).toBe(3);
        ...
        it('should parse nested ICU messages', function () {
            var original = "{gender_of_host, select, \n  female {\n    {num_guests, plural, \n      =0 {{host} does not give a party.}\n      =1 {{host} invites {guest} to her party.}\n      =2 {{host} invites {guest} and one other person to her party.}\n      other {{host} invites {guest} and # other people to her party.}}}\n  male {\n    {num_guests, plural, \n      =0 {{host} does not give a party.}\n      =1 {{host} invites {guest} to his party.}\n      =2 {{host} invites {guest} and one other person to his party.}\n      other {{host} invites {guest} and # other people to his party.}}}\n  other {\n    {num_guests, plural, \n      =0 {{host} does not give a party.}\n      =1 {{host} invites {guest} to their party.}\n      =2 {{host} invites {guest} and one other person to their party.}\n      other {{host} invites {guest} and # other people to their party.}}}}";
            var parsedMessage = parsedICUMessage(original, null, 'xlf');
            expect(parsedMessage.asDisplayString()).toBe('<ICU-Message/>');
            expect(parsedMessage.getICUMessage()).toBeTruthy();
            var outerIcuMessage = parsedMessage.getICUMessage();
            ...
            var innerMessage = outerIcuMessage.getCategories()[1].getMessageNormalized();
            expect(innerMessage.asDisplayString()).toBe('<ICU-Message/>');
            var innerIcuMessage = innerMessage.getICUMessage();
        ...
        it('should parse nested ICU messages with placeholder', function () {
...
//# sourceMappingURL=S:/experimente/ngx-i18nsupport-lib/src/impl/parsed-message.spec.js.map