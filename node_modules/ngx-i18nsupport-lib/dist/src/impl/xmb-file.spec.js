 ...
 */
describe('ngx-i18nsupport-lib xmb test spec', function () {
    ...
    describe('xmb format tests', function () {
        var MASTER1SRC = SRCDIR + 'ngExtractedMaster1.xmb';
        var MASTER_DE_XMB = SRCDIR + 'ngExtractedMaster1.de.xmb';
        var TRANSLATED_FILE_SRC = SRCDIR + 'ngExtractedMaster1.en.xtb';
        ...
        it('should return source language (by guessing from file name)', function () {
            var file = readFile(MASTER1SRC);
            expect(file.sourceLanguage()).toBeFalsy();
            var file2 = readFile(MASTER_DE_XMB);
            expect(file2.sourceLanguage()).toBe('de');
        });
        it('should return target language null', function () {
            var file = readFile(MASTER1SRC);
            expect(file.targetLanguage()).toBeFalsy();
        });
        it('should loop over all trans units', function () {
            var translatedFile = readFile(MASTER_DE_XMB);
            var count = 0;
        ...
        it('should ignore change source content', function () {
            var file = readFile(MASTER_DE_XMB);
        ...
        it('should copy a transunit from file a to file b', function () {
            ...
            var tu = file.transUnitWithId(ID_TO_MERGE);
            expect(tu).toBeTruthy();
            var targetFile = file.createTranslationFileForLang('de', null, false, true);
        ...
        it('should not be translatable at all', function () {
            var file = readFile(MASTER1SRC);
            var tu = file.transUnitWithId(ID_MY_FIRST);
            expect(tu).toBeTruthy();
...
//# sourceMappingURL=S:/experimente/ngx-i18nsupport-lib/src/impl/xmb-file.spec.js.map